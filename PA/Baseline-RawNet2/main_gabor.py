...
from Gabor_RawNet import RawNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default=r'I:\2021\outputs\output.txt')
    ...
    # evaluation
    if args.eval:
        files_meta_eval = genSpoof_list(is_logical=is_logical, is_train=False,
                                        is_eval=args.eval)
