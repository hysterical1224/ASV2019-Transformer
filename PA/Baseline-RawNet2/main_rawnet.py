...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default=r'I:\2021\data\PA/', help='Change with path to user\'s PA database protocols directory address')
    '''
    % protocols_path/
    ...
    parser.add_argument('--eval_output', type=str, default=r'I:\2021\outputs\output.txt',
    ...
    parser.add_argument('--save_path', type=str, default= r'I:\2021\outputs\output_40.txt')
